package com.github.tianmu19.baselibrary.utils.handler;
...
public class THandler {
     ...
     */
    public THandler(@Nullable Handler.Callback callback) {
     ...
     */
    public THandler(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public THandler(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
